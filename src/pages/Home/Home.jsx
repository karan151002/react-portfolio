    ...
    >
      <div className="aboutContainer">
        ...
        <div className="aboutProfile">
          <p>
            Hey! I’m Karan Dharmaraj, a passionate Full Stack Developer from
            Coimbatore, India. With a bachelor's degree in Computer Science with Data Analytics, I
          ...
          <div style={{ fontSize: "18px" }}>
            <u>contact: </u>
            <u>
              <a href="mailto:karandharmaraj15@gmail.com">
              karandharmaraj15@gmail.com
              </a>
            </u>
          </div>
        </div>
        ...
        <div className="education">
          ...
          <div className="college">
            <div className="collegeName">
              <h1>COLLEGE</h1>
              <h3>BSc Computer Science With Data Analytics</h3>
              <p> Dr NGP College of Arts and Science, Coimbatore </p>
            </div>
            <div className="batch">
              <div>
                <h1>Batch</h1>
        ...
        <div className="achievements">
          <div className="fswd">
            <div>
              ...
              <p>
                ...
                Node.js) at Kgisl MicroCollege! Learning Center. Awarded the Certificate of
          ...
          <div className="internship">
            <div>
              ...
              <p>
                Completed an internship at Kgisl Micro College! Learning from April
                to November 2024, during which I earned a certificate for my
